            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  key={link.key}
                  href={link.href}
                  className={`text-[13px] xl:text-[15px] font-bold tracking-tight whitespace-nowrap transition-all duration-300 relative group py-2 ${
                    isActive 
                      ? 'text-primary' 
                  ...
                  >
                    {(['en', 'uz', 'ru'] as const).map((lang) => (
                      <button
                        ...
                        className={`px-4 py-2 text-base font-bold text-left transition-colors whitespace-nowrap ${
                          language === lang
