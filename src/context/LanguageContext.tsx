...
const translations: Record<Language, any> = {
  en: {
    ...
    portfolio: {
      ...
      all: 'All',
      desc1: 'Modern IT education center platform and interactive student learning dashboard built with React and TypeScript.',
      desc2: 'Comprehensive pharmacy management system and inventory dashboard for tracking medical supplies and sales.',
      desc3: 'Personal developer portfolio featuring responsive glassmorphism design, smooth animations, and dynamic dark mode.',
  ...
  uz: {
    ...
    portfolio: {
      ...
      all: 'Hammasi',
      desc1: 'IT ta\'lim markazi va o\'quvchilar uchun zamonaviy boshqaruv platformasi hamda interaktiv o\'quv kursi paneli.',
      desc2: 'Dorixona va tibbiy mahsulotlar hisob-kitobini yuritish hamda omborni nazorat qilish tizimi.',
      desc3: 'Shaxsiy veb portfolio loyihasi: React, TypeScript, Tailwind CSS hamda Framer Motion animatsiyalari.',
  ...
  ru: {
    ...
    portfolio: {
      ...
      all: 'Все',
      desc1: 'Современная образовательная IT-платформа и интерактивная панель управления для студентов.',
      desc2: 'Система управления аптекой и панель учета медицинских товаров и складского оборота.',
      desc3: 'Личное портфолио разработчика с анимациями Framer Motion, адаптивной версткой и темной темой.',
